...
- :new: indicates additions to the gameplay guide since the last release
...
- [Alternate Start - Live Another Life](https://www.nexusmods.com/skyrimspecialedition/mods/272) - Live Another Life provides an alternative means to start the game for those who do not wish to go through the lengthy intro sequence at Helgen.
...
- [Ish's Respec Mod](https://www.nexusmods.com/skyrimspecialedition/mods/1960) - Adds a purchasable potion allowing you to respec your perk points.
- [Shovels Bury Bodies](https://www.nexusmods.com/skyrimspecialedition/mods/52984) - Use shovel to clean up bodies. Access buried bodies via MCM.
...
- [Sweeping Organizes Stuff](https://www.nexusmods.com/skyrimspecialedition/mods/51645) - Use broom to clean up physics mess
...
- :new: [Legion - A Bruma Encounter Zone Overhaul](https://www.nexusmods.com/skyrimspecialedition/mods/60848) - Legion is an encounter zone overhaul for Beyond Skyrim: Bruma. It is designed in a way which allows players to make judgements based on enemy types. Increases the difficulty of dungeons by re-leveling the enemies.
...
- [Radiant Requirements](https://www.nexusmods.com/skyrimspecialedition/mods/45427) - Modifies select radiant quests so that they don't send you to locations with dangerous enemies until your level is high enough.
- [Rebalancing Anniversary Edition - Quest Requirements](https://www.nexusmods.com/skyrimspecialedition/mods/61004) - Creation Club content being thrown at you from level 1 completely destroyed any sense of progression in the game. This mod changes that. No more dragonbone and daedric artifacts at level 1.
...
- [Skyrim's Paraglider](https://www.nexusmods.com/skyrimspecialedition/mods/53256) - Adds a paraglider into the world similar to that in breath of the wild. You need to find it in the world to use it.
  > :ledger: Uses stamina while flying so be careful!
- [Survival Mode](https://en.uesp.net/wiki/Skyrim:Survival_Mode) - In Survival Mode, your greatest adversary is Skyrim itself. Unrelenting cold, harsh wilderness, famine and fatigue - do you have the strength to endure? (Survival Mode can be turned on or off in Settings menu.)
   ...
   > :ledger: You can see the survival mode effects (tired, cold, hungry) on the [Immersive HUD - iHUD](https://www.nexusmods.com/skyrim/mods/3222/). Press the <kbd>X</kbd> key to toggle the immersive HUD's visibility.
- [The Ultimate Dodge Mod Reborn](https://www.nexusmods.com/skyrimspecialedition/mods/63000) - Introduces a dodge mechanic where you can dodge out of the way of attacks for a stamina cost. Optional support for NPC dodging.
...
- :new: [Curators Companion](https://www.nexusmods.com/skyrimspecialedition/mods/38529) - The all in one Legacy of the Dragonborn companion!
- :new: [Relic Hunter- Guildmaster Start](https://www.nexusmods.com/skyrimspecialedition/mods/12253) - Begin your Legacy experience with a new Alternate Start Live Another Life option as Guild Master for the Explorer's Society!
  > :ledger: This appears as "Alternate Start - Live Another Life - Legacy of the Dragonborn" in the Alternate Start section
- :new: [Return to Pelagius' Mind](https://www.nexusmods.com/skyrimspecialedition/mods/31344) - Travel back to Pelagius' mind to retrieve items you forgot about. For example, Legacy of the Dragonborn's Jyggalag's Sword.
...
- [Animated Heavy Armory](https://www.nexusmods.com/skyrimspecialedition/mods/6308) - Heavy armory introduces new weapons similar to animated armory with new animations to bring variety to the world.
...
- [Drelas' Cottage](https://www.nexusmods.com/skyrimspecialedition/mods/39829) - Inherit Drelas' Cottage if the owner has an unfortunate accident.
