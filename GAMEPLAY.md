...
This list includes all of Simon's overhauls. They attempt to overhaul various systems in Skyrim in a way that stays true to the original while improving the balance and gameplay. The full list in no particular order:
...
Travel to the far desert in this DLC-sized mod and discsover unique and powerful artifacts.
