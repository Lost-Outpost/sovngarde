...
- [Animated Armory](https://www.nexusmods.com/skyrimspecialedition/mods/51100) `2.0.0` - Animated armory introduces new weapons and animations to existing ones. Most are craftable and all will show up in the world on NPCs.
...
- [Common Clothes and Armors](https://www.nexusmods.com/skyrimspecialedition/mods/21305) `2.0.0` - Common clothes and armors adds new armor variants and clothes around skyrim for more diversity.
...
- [Depths of Skyrim](https://www.nexusmods.com/skyrimspecialedition/mods/26913) `2.0.0` - Overhauls the underwater environment and adds content to the sea of Ghosts

- [Dwemer Spectres](https://www.nexusmods.com/skyrimspecialedition/mods/8016) `2.0.0` - Your favorite ghost-related dwemer creature mod is back! This adds in the old Dwemer Spectres for Morrowind, complete with multiple types, unique bosses with unique rewards, and stupid hats.
...
- [Moon and Star](https://www.nexusmods.com/skyrimspecialedition/mods/4301) `2.0.0` - Investigate a mysterious powerful individual in skyrim. There may be more to this individual than it seems.

- [The Tools of Kagrenac](https://www.nexusmods.com/skyrimspecialedition/mods/14168) `2.0.0` - Go on a quest to recover the legendary Tools of Kagrenac. Encounter new allies and enemies, explore sprawling dungeons, and add powerful new artifacts and spells to your arsenal in this fully-voiced quest mod!

- [Undeath Remastered](https://www.nexusmods.com/skyrimspecialedition/mods/6180) `2.0.0` - Travel to dark depths and become a powerful Lich.
